...
String mapToUserMessage(Object error) {
  if (error is DomainException) return _mapDomainException(error);
  return '오류가 발생했습니다. 앱을 다시 시작해 주세요.';
}

String _mapDomainException(DomainException e) => switch (e) {
      ...
      InvalidStateTransitionException() => '현재 상태에서는 해당 작업을 수행할 수 없습니다.',
      ...
      CreditAccountHasBalanceException() => '미납 잔액이 남아 있는 외상 계좌는 삭제할 수 없습니다.',
      MenuItemInUseException() => '진행 중인 주문에서 사용 중인 메뉴는 삭제할 수 없습니다.',
      SeatInUseException() => '진행 중인 주문이 연결된 좌석은 삭제할 수 없습니다.',
      DuplicateSeatNumberException() => '이미 사용 중인 좌석 번호입니다. 다른 번호를 입력하세요.',
      ...
      OrderNotEditableException() => '수정할 수 없는 상태의 주문입니다.',
      MenuNotAvailableException() => '판매 중단된 메뉴입니다.',
      MinimumOrderItemException() => '주문에는 최소 1개의 항목이 있어야 합니다.',
    };
