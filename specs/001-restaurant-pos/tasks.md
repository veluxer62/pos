...
- [X] T084 [P] 통합 테스트 작성: `integration_test/us1_order_flow_test.dart` — 영업 시작 → 주문 생성 → 전달 완료 시나리오
- [X] T085 [P] 통합 테스트 작성: `integration_test/us2_payment_flow_test.dart` — 즉시 결제 + 외상 결제 시나리오
